...
Wee.fn.make("common",{init:function(){var a=this.$private;a.initializeStorage(),a.initializeApp(),a.addHelpers(),a.bind(),a.monitorStock()}},{bind:function(){var a=this;$.events.on({"ref:buy":{click:function(b){var c=Wee.app.stockManager.$get();c.trader.capital>c.price&&a.modifyStock("buy",b.shiftKey,b.altKey)}},"ref:sell":{click:function(b){Wee.app.stockManager.$get("trader.stock")&&a.modifyStock("sell",b.shiftKey,b.altKey)}}})},initializeApp:function(){Wee.data.request({url:"https://www.google.com/finance/info?q=TSLA",jsonp:!0,success:function(a){var b={};b.symbol=a[0].t,b.price=a[0].l_cur,b.absoluteChange=a[0].c_fix,b.percentChange=a[0].cp_fix,b.trader=JSON.parse(localStorage.getItem("trader")),Wee.app.make("stockManager",{target:"ref:stock",view:"stock",model:b})}})},initializeStorage:function(){if(!Wee._win.localStorage||!localStorage.getItem("trader")){var a={name:"John Doe",capital:1e5,earnings:0,timeLeft:Math.floor((new Date).getTime()/1e3),stockAmount:0,stock:0};localStorage.setItem("trader",JSON.stringify(a))}},modifyStock:function(a,b,c){var d,e=Wee.app.stockManager.$get(),f=c?100:b?10:1,g=e.price*f;"buy"==a?(d=e.trader.capital-parseInt(g),Wee.app.stockManager.$set("trader.capital",d),Wee.app.stockManager.$set("trader.earnings",d-1e5),Wee.app.stockManager.$set("trader.stock",e.trader.stock+f)):(d=e.trader.capital+parseInt(g),Wee.app.stockManager.$set("trader.capital",d),Wee.app.stockManager.$set("trader.stock",Math.abs(e.trader.stock-f)),Wee.app.stockManager.$set("trader.earnings",d-1e5)),localStorage.setItem("trader",JSON.stringify(e.trader))},monitorStock:function(){setInterval(function(){Wee.data.request({url:"https://www.google.com/finance/info?q=TSLA",jsonp:!0,success:function(a){Wee.app.stockManager.$set("symbol",a[0].t),Wee.app.stockManager.$set("price",a[0].l_cur),Wee.app.stockManager.$set("absoluteChange",a[0].c_fix),Wee.app.stockManager.$set("percentChange",a[0].cp_fix),Wee.app.stockManager.$set("trader",JSON.parse(localStorage.getItem("trader")))}})},5e3)},addHelpers:function(){Wee.view.addHelper("formatMoney",function(){return parseInt(this.val).toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g,"$1,")}),Wee.view.addHelper("formatTime",function(){return Math.floor((480-((new Date).getTime()/1e3-parseInt(this.val))/60)/60)})}}),Wee.routes.map({$any:"common"}),Wee.ready("routes:run"),Wee.fn.make("todo",{init:function(){var a=Wee.app.make("todo",{view:"welcome.todo",target:"ref:todo",model:[{label:"Download and run Wee",done:!0},{label:"Explore the guide and welcome modules"},{label:"Reset your project to a blank slate"},{label:"Customize wee.json"},{label:"Build something incredible"}]});$("ref:toggle").on("click",function(){var b=$(this).data("id"),c=!a.$get(b+".done");a.$set(b+".done",c)})}}),Wee.routes.map({$root:"todo"});
